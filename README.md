...
| 전체 게시글(실시간) | 
| :---: |
| ![게시글 페이지](./image/전체%20게시글.gif) | 
| 게시글 페이지에서 게시글을 작성하거나 실시간으로 업로드되는 글을 볼 수 있습니다. | 

| 게시글 상세 | 
| :---: |
| ![게시글 상세 페이지](./image/게시글%20상세.gif) | 
...
| 채팅방 목록 및 생성 | 
| :---: |
| ![채팅방 생성 페이지](./image/채팅방%20생성.gif) | 
| 채팅방 페이지에서는 채팅방을 생성하거나 들어갈 수 있습니다. | 

| 채팅방 페이지 | 
| :---: |
| ![채팅방 페이지](./image/채팅방%20페이지.gif) | 
