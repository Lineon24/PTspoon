...
export function FeatureToggle({ emoji, label, description, isSelected, onToggle }: FeatureToggleProps) {
  return (
    <button
      onClick={onToggle}
      className={cn(
    ...
    >
      ...
      <p className="font-bold text-xs text-gray-800 dark:text-gray-200">{label}</p>
