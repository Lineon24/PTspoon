...
import { RestaurantListItem, type Restaurant } from "@/components/restaurant-list-item_ver2"; // 레스토랑 리스트 아이템과 타입 import
...
export default function RestaurantsPage() {
  ...
  const handleEnterSearch=async()=>{
    ...
    // 최종적으로 상태에 저장 (Restaurant[] 타입으로 타입 에러 없이 안전함) 개씨발 계속해서 오류가 나서 추가함
  ...
  return (
    <div className="max-w-[540px] mx-auto p-3">
      <HeaderWithBack title="식당 목록" backTF= {true} /> {/* 상단 고정 헤더 */}
      {/* 검색창 및 필터 버튼 */}
